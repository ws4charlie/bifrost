...
| Mode | Runtime request/response | Bifrost logs | Trace/export connectors | Reveal supported |
|------|--------------------------|--------------|-------------------------|------------------|
| `runtime` | Redacted with `replace`, `mask`, or `hash` | Redacted the same way | Redacted content only | No |
| `logs_only` | Left raw | Redacted with reversible placeholders | Placeholderized content | Yes, for Bifrost logs only |
| `runtime_reversible` | Redacted with reversible placeholders | Redacted with reversible placeholders | Placeholderized content | Yes, for Bifrost logs only |
